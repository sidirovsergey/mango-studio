...
export const demoScripts: Record<string, ScriptGenOutput> = {
  default: {
    ...
    scenes: [
      ...
      {
        scene_id: 's4',
        description: 'Вторая преграда: его не пускают в кабинет, потому что он не помещается в дверь.',
        duration_sec: 8,
      },
      {
        scene_id: 's5',
        description: 'Развязка: Джек предлагает ему стать инструктором по плаванию для младших крабиков. Идеально.',
        duration_sec: 10,
      },
    ],
    characters: [
      { name: 'Дэнни', description: 'Оптимистичный дельфин, ищет работу. С новыми очками.' },
      { name: 'Джек', description: 'Сердитый менеджер по найму. Сидит за столом из коралла.' },
      { name: 'Лили', description: 'Секретарь. Печатает восемью щупальцами одновременно.' },
      { name: 'Грейс', description: 'Хитрая лиса-рекрутер, читает тебя на сквозь.' },
      { name: 'Тэдди', description: 'Уютный CEO-медведь, любит совещания у камина.' },
    ],
  },
};
