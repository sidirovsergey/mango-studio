  ...
  return (
    ...
    <div className="char-actions" onClick={(e) => e.stopPropagation()}>
      ...
      <button
        type="button"
        className="icon-btn"
        onClick={stop(() => setOpenPop('refine'))}
        title="Уточнить промптом"
        aria-label="Уточнить промптом"
      >
        <svg className="i" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <button
        type="button"
        className="icon-btn"
        onClick={stop(openRef)}
        title="Прикрепить референс"
        aria-label="Прикрепить референс"
      >
        <svg className="i" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <button
        type="button"
        className="icon-btn"
        onClick={stop(() => setOpenPop('delete'))}
        title="Удалить"
        aria-label="Удалить"
      >
        <svg className="i" viewBox="0 0 24 24" aria-hidden="true">
