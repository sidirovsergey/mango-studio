export default function HomePage() {
  return (
    <main className="min-h-screen p-10 flex flex-col gap-6">
      <h1 className="font-display text-4xl text-ink-900">Mango Studio · token sanity check</h1>
      ...
      <div className="font-serif text-2xl text-ink-700">Fraunces serif для акцентов</div>
    </main>
  );
}
